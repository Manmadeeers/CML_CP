...
function displayData(xmlString) {
   ...
   //    var good_number = index.toString();//convert int to string
   //    let good = xmlDoc.getElementsByTagName("good"+good_number)[0];
   //    let name = good.getElementsByTagName("name")[0].childNodes[0].nodeValue;
   //    let price = good.getElementsByTagName("price")[0].childNodes[0].nodeValue;
   //    document.getElementById('g'+good_number).textContent = name;
   //    document.getElementById('g'+good_number+'txt').textContent = price;
   //    console.log(index);
   // }
}
